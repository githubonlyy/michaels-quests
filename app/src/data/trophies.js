...
export const TROPHIES = [
  ...
  },
  {
    ...
    icon: 'truck',
    title: 'אלוף הרכבים',
    he: '5 ניצחונות ברכבים ומקצועות',
    check: (s) => (s.stats.winsBySubject.vehicles || 0) >= 5,
  },
  {
    id: 'master-sounds',
    icon: 'sound',
    title: 'אלוף החיות',
    he: '5 ניצחונות בקולות בעלי חיים',
    check: (s) => (s.stats.winsBySubject.sounds || 0) >= 5,
  },
  {
    id: 'master-digits',
    icon: 'digits',
    title: 'אלוף המספרים',
    he: '5 ניצחונות בספרות',
    check: (s) => (s.stats.winsBySubject.digits || 0) >= 5,
  },
  {
    id: 'master-opposites',
    icon: 'swap',
    title: 'אלוף ההפכים',
    he: '5 ניצחונות בהפכים',
    check: (s) => (s.stats.winsBySubject.opposites || 0) >= 5,
  },
  {
    id: 'rich',
    icon: 'coins',
